...
class Grille:
    ...
    def creerGrille(self):
        ...
        celluleY = 0
        for x in range(self.canvasHeight):
    ...
    def creerCellule(self,event):
        ...
        if lig <= self.nb_cellules and col <= self.nb_cellules and not (lig, col) in self.cellule_en_vie:
    ...
    def cell_voisine(self, lig, col, test):
        '''
    ...
    #---------------------------------------------------------------------------------------------------
    def vie_ou_mort(self, cpt_cell_en_vie, lig, col):
        '''
        ...
        # et Si la cellule etait en vie au temps T
        if cpt_cell_en_vie == 2 and (lig, col) in self.cellule_en_vie:
    ...
    def go(self):
        if self.cellule_en_vie!=0 and self.drap==0:
            self.drap =1
            self.generations()
    ...
    def generations(self):
        ...
        if(self.drap==1):
            ...
            for lig, col in self.cellule_en_vie.keys():
                ...
                cpt_cell_en_vie = self.cell_voisine(lig, col, True)
                self.vie_ou_mort(cpt_cell_en_vie, lig, col)

            #Examen des cellules voisines de chaque cellule en vie
            for lig, col in self.cell_voisines.keys():
                if not (lig, col) in self.examen:
                    self.examen.setdefault((lig, col))
                    cpt_cell_en_vie = self.cell_voisine(lig, col, False)
                    self.vie_ou_mort(cpt_cell_en_vie, lig, col)
